...
- Phase 3AP records stale older prerelease guidance. `v0.1.0-dev.2` is the current recommended prerelease/dev release for new validation; `v0.1.0-dev.1` and `v0.1.0-dev` are stale/superseded for new installation, validation, and support evidence unless explicitly investigating historical behaviour.
...
- Phase 3AV records a manual packaged sanity failure for the published `v0.1.0-dev.2` native Open folder path, Phase 3AW remediates bounded pending guidance on `develop`, Phase 3AX freezes a local unpublished `v0.1.0-dev.3` publication bundle for a later approval gate only, and Phase 3AY audits that frozen bundle with no publication.
...
See `docs/roadmap/lens-docs-studio-v010-dev2-candidate-scope.md` for the Phase 3AI candidate `v0.1.0-dev.2` scope, `docs/roadmap/lens-docs-studio-v010-dev2-implementation-readiness.md` for the Phase 3AJ implementation readiness plan, `docs/architecture/lens-docs-studio-support-bundle-design.md` for the Phase 3AN design-only support bundle contract, `docs/release/lens-docs-studio-installer-upgrade-uninstall-evidence-plan.md` for the Phase 3AO installer evidence plan, `docs/release/lens-docs-studio-prerelease-guidance.md` for the Phase 3AP stale older prerelease guidance, `docs/release/lens-docs-studio-v010-dev2-release-closure.md` for the Phase 3AU closure and roadmap rebaseline, `docs/release/phase-3aw-open-folder-picker-remediation.md` for the Phase 3AW remediation, `docs/release/lens-docs-studio-v010-dev3-publication-bundle-freeze.md` for the Phase 3AX local bundle freeze, `docs/release/lens-docs-studio-v010-dev3-publication-preflight.md` for the Phase 3AY frozen bundle audit, and `docs/release/lens-docs-studio-prerelease-feedback-intake.md` for the prerelease feedback intake process.
