...
- Phase 3AV records a manual packaged sanity failure for the published `v0.1.0-dev.2` native Open folder path, Phase 3AW remediates bounded pending guidance on `develop`, and Phase 3AX freezes a local unpublished `v0.1.0-dev.3` publication bundle for a later approval gate only.
