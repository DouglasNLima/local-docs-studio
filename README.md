...
Phase 3Q records that `v0.1.0-dev` is a public GitHub prerelease, not stable/latest. Phase 3AG records that `v0.1.0-dev.1` was published as a verified prerelease after Stage A and Stage B packaged evidence, publication from the frozen Phase 3AD bundle, and Phase 3AF post-publication verification. Phase 3AH opened the post-prerelease backlog, Phase 3AI converted it into candidate `v0.1.0-dev.2` scope plus a prerelease feedback intake process, Phase 3AJ recorded implementation readiness, Phase 3AK/3AL/3AM completed diagnostics, onboarding, and watcher/conflict copy slices, Phase 3AN recorded a design-only optional troubleshooting/support bundle contract without approving implementation, Phase 3AO recorded installer upgrade/uninstall evidence planning only, Phase 3AP recorded stale older prerelease guidance, Phase 3AS recorded authorised `v0.1.0-dev.2` prerelease publication from the frozen Phase 3AR bundle, and Phase 3AT verified the published prerelease. Phase 3AV then recorded a manual packaged sanity failure for the published `v0.1.0-dev.2` native Open folder path, Phase 3AW remediated the bounded pending guidance on `develop`, Phase 3AX froze a local `v0.1.0-dev.3` candidate bundle, Phase 3AY audited that frozen bundle as a no-publication preflight, Phase 3BA verified the published `v0.1.0-dev.3` prerelease, and Phase 3BB closes the dev.3 evidence chain as documentation-only release closure and roadmap rebaseline. The current published prerelease/dev release for new validation is `v0.1.0-dev.3`; `v0.1.0-dev.2` and `v0.1.0-dev.1` are superseded for new validation but preserved historically, and `v0.1.0-dev` is older/stale. Phase 3BA post-publication verification passed, while Phase 3AW remains the referenced manual packaged sanity/remediation evidence because Phase 3BA skipped interactive manual packaged sanity. Phase 3BE implements explicit-user-action local support bundle generation in Diagnostics. Phase 3BF adds a design/planning-only manual packaged sanity helper plan; no helper script or runtime shortcut exists yet. No further release asset action is required unless a future release is authorised, and no older release assets were modified by that guidance. The ZIP remains available as the portable fallback for manual extraction, smoke validation, and environments avoiding installers; it does not create Start Menu or uninstall entries. The unsigned Inno Setup installer is the easier Windows install path with a Start Menu shortcut, optional Desktop shortcut, optional/default-safe file associations, uninstall support, and the WebView2 user data caveat. Runtime prerequisites remain separate, and structured prerelease feedback should use `docs/release/lens-docs-studio-prerelease-feedback-intake.md`. See `docs/release/lens-docs-studio-v010-dev1-release-closure.md`, `docs/release/lens-docs-studio-v010-dev2-release-closure.md`, `docs/release/lens-docs-studio-v010-dev2-post-publication-verification.md`, `docs/release/lens-docs-studio-v010-dev2-publication-record.md`, `docs/release/phase-3aw-open-folder-picker-remediation.md`, `docs/release/lens-docs-studio-v010-dev3-publication-bundle-freeze.md`, `docs/release/lens-docs-studio-v010-dev3-publication-preflight.md`, `docs/release/lens-docs-studio-v010-dev3-publication-record.md`, `docs/release/lens-docs-studio-v010-dev3-post-publication-verification.md`, `docs/release/lens-docs-studio-v010-dev3-release-closure.md`, `docs/roadmap/lens-docs-studio-post-v010-dev1-backlog.md`, `docs/roadmap/lens-docs-studio-v010-dev2-candidate-scope.md`, `docs/roadmap/lens-docs-studio-v010-dev2-implementation-readiness.md`, `docs/release/phase-3al-first-run-onboarding-copy-polish.md`, `docs/release/phase-3am-watcher-conflict-ux-copy-refinement.md`, `docs/architecture/lens-docs-studio-support-bundle-design.md`, `docs/release/phase-3be-support-bundle-implementation.md`, `docs/testing/lens-docs-studio-manual-packaged-sanity-helper-plan.md`, `docs/release/lens-docs-studio-installer-upgrade-uninstall-evidence-plan.md`, and `docs/release/lens-docs-studio-prerelease-guidance.md`.
...
- Phase 3AP records stale older prerelease guidance. Phase 3BB rebaselines that guidance so `v0.1.0-dev.3` is the current recommended prerelease/dev release for new validation; `v0.1.0-dev.2` and `v0.1.0-dev.1` are superseded for new validation but preserved historically, and `v0.1.0-dev` is older/stale unless explicitly investigating historical behaviour.
...
- Phase 3AV records a manual packaged sanity failure for the published `v0.1.0-dev.2` native Open folder path, Phase 3AW remediates bounded pending guidance on `develop`, Phase 3AX freezes a local `v0.1.0-dev.3` publication bundle, Phase 3AY audits that frozen bundle with no publication, Phase 3BA verifies the published `v0.1.0-dev.3` prerelease, and Phase 3BB closes it as the current verified prerelease/dev release. Phase 3AW remains the referenced manual packaged sanity/remediation evidence, and Phase 3BA skipped interactive manual packaged sanity.
- Phase 3BC records the post-`v0.1.0-dev.3` backlog and candidate `v0.1.0-dev.4` scope as documentation/planning only. Phase 3BD adds the implementation readiness plan for the possible `v0.1.0-dev.4` cycle, Phase 3BE implements the first approved slice: explicit-user-action Diagnostics support bundle generation, and Phase 3BF defines the manual packaged sanity helper/checklist approach as planning only. No Phase 3BF helper script or runtime shortcut is implemented. `v0.1.0-dev.4` is not approved, has no committed release date, changes no release assets, and does not claim production readiness or go-live approval.
...
See `docs/roadmap/lens-docs-studio-v010-dev2-candidate-scope.md` for the Phase 3AI candidate `v0.1.0-dev.2` scope, `docs/roadmap/lens-docs-studio-v010-dev2-implementation-readiness.md` for the Phase 3AJ implementation readiness plan, `docs/architecture/lens-docs-studio-support-bundle-design.md` for the Phase 3AN support bundle contract, `docs/release/lens-docs-studio-installer-upgrade-uninstall-evidence-plan.md` for the Phase 3AO installer evidence plan, `docs/release/lens-docs-studio-prerelease-guidance.md` for the current prerelease guidance, `docs/release/lens-docs-studio-v010-dev2-release-closure.md` for the Phase 3AU closure and roadmap rebaseline, `docs/release/phase-3aw-open-folder-picker-remediation.md` for the Phase 3AW remediation, `docs/release/lens-docs-studio-v010-dev3-publication-bundle-freeze.md` for the Phase 3AX local bundle freeze, `docs/release/lens-docs-studio-v010-dev3-publication-preflight.md` for the Phase 3AY frozen bundle audit, `docs/release/lens-docs-studio-v010-dev3-publication-record.md` and `docs/release/lens-docs-studio-v010-dev3-post-publication-verification.md` for the dev.3 publication and verification evidence, `docs/release/lens-docs-studio-v010-dev3-release-closure.md` for the Phase 3BB closure and roadmap rebaseline, `docs/roadmap/lens-docs-studio-post-v010-dev3-backlog.md` for the Phase 3BC post-dev.3 backlog, `docs/roadmap/lens-docs-studio-v010-dev4-candidate-scope.md` for the planning-only candidate dev.4 scope, `docs/roadmap/lens-docs-studio-v010-dev4-implementation-readiness.md` for the Phase 3BD implementation readiness plan, `docs/release/phase-3be-support-bundle-implementation.md` for the Phase 3BE support bundle implementation evidence, `docs/testing/lens-docs-studio-manual-packaged-sanity-helper-plan.md` for the Phase 3BF manual packaged sanity helper design, and `docs/release/lens-docs-studio-prerelease-feedback-intake.md` for the prerelease feedback intake process.
...
- `docs/testing/lens-docs-studio-manual-packaged-sanity-helper-plan.md` captures the design-only manual packaged sanity helper/checklist approach. No helper script is implemented yet.
