...
Phase 3Q records that `v0.1.0-dev` is a public GitHub prerelease, not stable/latest. Phase 3AG records that `v0.1.0-dev.1` is now published as a verified prerelease after Stage A and Stage B packaged evidence, publication from the frozen Phase 3AD bundle, and Phase 3AF post-publication verification. Phase 3AH opens the post-prerelease backlog, Phase 3AI converts it into candidate `v0.1.0-dev.2` scope plus a prerelease feedback intake process, Phase 3AJ records implementation readiness and the recommended first slice without approving release publication, Phase 3AL records first-run/onboarding copy polish after Phase 3AK diagnostics visibility, Phase 3AM records watcher/conflict copy refinement, Phase 3AN records a design-only optional troubleshooting/support bundle contract without approving implementation, Phase 3AO records installer upgrade/uninstall evidence planning only, Phase 3AP records stale older prerelease guidance, and Phase 3AS records authorised `v0.1.0-dev.2` prerelease publication from the frozen Phase 3AR bundle. The current recommended prerelease/dev release for new validation is `v0.1.0-dev.2`; the older `v0.1.0-dev.1` and `v0.1.0-dev` assets are stale/superseded for new installation, validation, and support evidence unless explicitly investigating historical behaviour. No older release assets were modified by that guidance. The ZIP remains available as the portable fallback for manual extraction, smoke validation, and environments avoiding installers; it does not create Start Menu or uninstall entries. The unsigned Inno Setup installer is the easier Windows install path with a Start Menu shortcut, optional Desktop shortcut, optional/default-safe file associations, uninstall support, and the WebView2 user data caveat. Runtime prerequisites remain separate, and structured prerelease feedback should use `docs/release/lens-docs-studio-prerelease-feedback-intake.md`. See `docs/release/lens-docs-studio-v010-dev1-release-closure.md`, `docs/release/lens-docs-studio-v010-dev2-publication-record.md`, `docs/roadmap/lens-docs-studio-post-v010-dev1-backlog.md`, `docs/roadmap/lens-docs-studio-v010-dev2-candidate-scope.md`, `docs/roadmap/lens-docs-studio-v010-dev2-implementation-readiness.md`, `docs/release/phase-3al-first-run-onboarding-copy-polish.md`, `docs/release/phase-3am-watcher-conflict-ux-copy-refinement.md`, `docs/architecture/lens-docs-studio-support-bundle-design.md`, `docs/release/lens-docs-studio-installer-upgrade-uninstall-evidence-plan.md`, and `docs/release/lens-docs-studio-prerelease-guidance.md`.
...
- Phase 3AH records the post-prerelease backlog and `v0.1.0-dev.2` planning gate. The next release scope is not yet approved.
